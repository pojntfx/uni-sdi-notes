---
author: [Jakob Waibel, Felicitas Pojtinger]
date: "2022-01-10"
...
sudo mv /tmp/nextcloud/nextcloud/ /var/www/nextcloud.felicitass-sdi1.alphahorizon.io/
sudo chown -R www-data:www-data /var/www/nextcloud.felicitass-sdi1.alphahorizon.io/
sudo chmod -R 755 /var/www/nextcloud.felicitass-sdi1.alphahorizon.io/

sudo tee /etc/apache2/sites-available/nextcloud.felicitass-sdi1.alphahorizon.io.conf <<'EOT'
<VirtualHost *:8080>
        ServerName felicitass-sdi1.alphahorizon.io
        ServerAlias nextcloud.felicitass-sdi1.alphahorizon.io

        ServerAdmin webmaster@alphahorizon.io
        DocumentRoot /var/www/nextcloud.felicitass-sdi1.alphahorizon.io

        ErrorLog ${APACHE_LOG_DIR}/error.log
        CustomLog ${APACHE_LOG_DIR}/access.log combined

        <Directory "/var/www/nextcloud.felicitass-sdi1.alphahorizon.io">
                Options Indexes FollowSymLinks
                AllowOverride None
                Require all granted
        </Directory>
...
EOT
sudo a2ensite nextcloud.felicitass-sdi1.alphahorizon.io
sudo systemctl reload apache2

curl https://nextcloud.felicitass-sdi1.alphahorizon.io/ # Access the Nextcloud installer

# Now visit https://nextcloud.felicitass-sdi1.alphahorizon.io/index.php and create an admin account
...
# - Visit https://nextcloud.felicitass-sdi1.alphahorizon.io/index.php/login and login as bean using password "password" (if you can't login, go back to https://nextcloud.felicitass-sdi1.alphahorizon.io/index.php/settings/admin/ldap and verify everything again)
```
